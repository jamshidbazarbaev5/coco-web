...
export default function ProductPage() {
  ...
  const nextImage = () => {
    const images =
      product?.product_attributes[selectedColorIndex]?.attribute_images || [];
  ...
  const getColorName = (
    hex: string,
    colorNameRu: string | null,
    colorNameUz: string | null
  ) => {
        ...
        <div className="product-image-container">
              ...
              <Image
                src={
                  product.product_attributes[selectedColorIndex]
                    ?.attribute_images?.[currentImageIndex]?.image ||
                  "/DETAILS.png"
                }
          ...
          <div className="thumbnail-container">
            {product.product_attributes[
              selectedColorIndex
            ]?.attribute_images.map((image, index) => (
              <div
                key={image.id}
                className={`thumbnail ${
            ...
            {product.product_attributes[selectedColorIndex].on_sale ? (
              <>
                <span className="original-price">
                  {formatPrice(
                    product.product_attributes[selectedColorIndex].price
                  )}
                </span>
                <span className="sale-price">
                  {formatPrice(
                    product.product_attributes[selectedColorIndex].new_price ||
                      ""
                  )}
                </span>
              </>
              ...
              {product?.product_attributes.map((attr, index) => (
                <button
                  ...
                  className={`color-option ${
                    selectedColor === attr.color_code ? "selected" : ""
                  }`}
                  onClick={() => {
          ...
          <div className="additional-info">
            ...
            <table className="info-table">
              <tbody>
                ...
                <tr>
                  <td className="info-label">
                    {t("product_details.table.material")}
                  </td>
                  <td className="info-value">
                    {params.lang === "uz"
              ...
              <div className="size-details">
                ...
                <table className="info-table">
                  <tbody>
                    <tr>
                      <td className="info-label">
                        {t("product_details.table.dimensions")}
                      </td>
                      <td className="info-value">
                        {(() => {
